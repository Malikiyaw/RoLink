...
//     .rl-tool-hide / .rl-cmd-mask) and re-measuring after a layout + 800ms gave
...
//
// Protocol: the isolated world dispatches a "rl-cm-sync" CustomEvent on
...
(() => {
  ...
  document.addEventListener("rl-cm-sync", () => { try { syncAll(); } catch {} }, true);
