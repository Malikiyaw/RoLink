...
const RLProvider = (() => {
  ...
  // Scope to the site's composer only; skip RoLink's own injected textarea
  ...
  function truncateForSend(text) {
    ...
    const marker =
      `\n\n[…RoLink: result truncated to fit Qwen's ${SEND_CAP}-character input ` +
  ...
  // tool-calls instead of RoLink commands. Removed 2026-07: the real cause of
