...
// command palette over all 117 tools. Mounts into #rl-root when main.js
...
(function (root) {
  ...
  function mount() {
    ...
    dockEl.innerHTML =
      '<div class="rl-dock-head">' +
        ...
        '<span class="rl-dock-sub"><span id="rl-dock-tools-n">117</span> tools</span>' +
    ...
    try {
      ...
      if (tn) tn.textContent = String(toolNames().length || 117);
    } catch (e) {}
  ...
  // ── command palette (Ctrl+K over all 117) ──────────────────────────
