...
// core/parser.js - RoLink command parsing. PURE string logic, zero DOM:
...
const ZSParse = (() => {
  ...
  // instead of a RoLink command - seen live in user reports, DeepSeek only:
  //   <|DSML|>tool_calls>
  ...
  // new RoLink schema ("command"/"params") and the legacy/function-calling
  ...
  // The assistant emitted a RoLink command (JSON or a ###LUA### block), or a
