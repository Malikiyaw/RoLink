...
// Full 111 inline would cost ~13k tokens/turn, so only the top-20 hot tools
// are authored here and shipped to the extension (see generated/tool-prompts.json
// + rolink-extension/core/tool-prompts.js). The rest fall back to TOOL_NOTES.
// Generated artifacts: `npm run generate:prompts` (scripts/generate-tool-prompts.ts).
